...
class SimpleNavigator(Node):
    def __init__(self):
        ...
        # Weitere Ziele koennen spaeter hier ergaenzt werden.
        self.goals = [
    ...
    def create_forward_goal(self, distance):
    ...
    def run(self):
        ...
        for goal_type, value in self.goals:
            if goal_type == 'forward':
                x, y, yaw = self.create_forward_goal(value)
